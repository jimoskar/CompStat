...
We observe that 
$$
\theta = \mathrm{Pr}\{X > 4\} = \int_4^{\infty}f(x) = \int_{-\infty}^{\infty}\mathbb{I}(x > 4) f(x) = \mathrm{E}_f[\mathbb{I}(X >4)].
$$

Then, by the method of Monte Carlo (MC) integration, an estimate of $\theta$ is
